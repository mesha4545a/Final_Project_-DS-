...
### The Project:
 ...
 - **Purpose This project aimed to utilize machine learning on the Covid-19 dataset to predict the future number New cases for ('International, World, Saudi Arabia)**
 ___
